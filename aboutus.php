...
<!--------------------body starts------------------>
    <div class="sub_header_in sticky_header">
        ...
        <main>
        <!---------------About senior place finder starts--------------- -->
                <div class="container margin_80_55">
        <div class="main_title_2">
            <span><em></em></span>
            <h2>Why Choose Senior Place Finder</h2>
            <p class="text-capitalize">
                The Power to find the right Assisted Living.
            </p>
        </div>
        <div class="row">
            <div class="col-lg-4 col-md-6">
                <a class="box_feat" >
                     <img alt="street-view-doll" src="svg/delivery.png" width="40" height="40">
                     <br><br>
                    <h3>Freedom to Act - 24/7</h3>
                    <p style="text-align:left;">
                        Find answers, choices, and select
                        who you want to contact for 
                        your reasons and when you're ready
                    </p>
                </a>
            </div>
            <div class="col-lg-4 col-md-6">
                <a class="box_feat" >
                   <img alt="accessibility" src="svg/accessibility.png" width="40" height="40">
                     <br><br>
                    <h3>Access to know</h3>
                    <p style="text-align:left;">
                        Information about the places
                        are provided by the companies
                        themselves, and kept accurate
                    </p>
                </a>
            </div>
            <div class="col-lg-4 col-md-6">
                <a class="box_feat" >
                    <img alt="accessibility" src="svg/dashboard.png" width="40" height="40">
                     <br><br>
                    <h3>Private Dashboard</h3>
                    <p style="text-align:left;">
                        Your email is your account to 
                        manage searches, compile lists    
                        for review, contacts, and update
                    </p>
                </a>
            </div>
            <div class="col-lg-4 col-md-6">
                <a class="box_feat" >
                   <img alt="headphone-symbol" src="svg/headphone-symbol.png" width="40" height="40">
                     <br><br>
                    <h3>Direct Line</h3>
                    <p style="text-align:left;">
                        You get direct access to call  
                    and email the representatives at 
                    the places 24/7 to get things done
                    </p>
                </a>
            </div>
            <div class="col-lg-4 col-md-6">
                <a class="box_feat" >
                   <img alt="headphone-symbol" src="svg/phone-book.png" width="40" height="40">
                     <br><br>
                    <h3>Update Efficiency</h3>
                    <p style="text-align:left;">
                        Anyone you choose to contact, the 
                    system sends update requests that
                    offer options to indicate status
                    </p>
                </a>
            </div>
            <div class="col-lg-4 col-md-6">
                <a class="box_feat" >
                    <img alt="headphone-symbol" src="svg/user (2).png" width="40" height="40">
                     <br><br>
                    <h3>Your Senior Team</h3>
                    <p style="text-align:left;">
                        Your account here includes quick access 
                    to the entire supply chain of businesses
                    and professionals serving seniors
                    </p>
                </a>
            </div>
        </div>
            ...
            <div class="row justify-content-between">
                <div class="col-lg-6 wow" data-wow-offset="50">
                    <figure class="block-reveal">
                        <img alt="" class="img-fluid" src="spf/img/slider/20.jpg">
                    </figure>
                </div>
                <div class="col-lg-6">
                    <p class="mb-3">
                        We have worked with so many seniors and 
                        families who so often were caught up in 
                        the confusion and uncertainty when shopping
                        for a place to live with care and assistance
                    </p>
                    <p class="mb-3">
                        Our vision was to make it easier by giving
                        shoppers access to direct knowledge and the
                        24/7 ability to reach the source and act
                    </p>
                    <p class="mb-3">
                        We also saw the barriers by not having
                        other answers and solutions so we have
                        connect the entire supply chain of businesses 
                        serving seniors and families
                    </p>
                    <p class="mb-3" >
                        So, now after you find a place to live, you can
                        find a senior real estate speialist, elder law 
                        lawyer, estate seller, packer, mover, 
                        investment advisor, and other professionals and 
                        specialists right from your Dashboard
                    </p>
                    <p class="mb-3">
                        It's your senior team for all the facets
                        of your senior life
                    </p>
                </div>
            </div>
    ...
    <!---------------about senior placefinder ends--------------- -->
    <div class="container margin_80_55">
        <div class="main_title_2">
            <span><em></em></span>
            <h2>Leadership Team</h2>
            <p>Meet the team working behind the screen to make the bridge between
            <br>elderly people and the senior living
               community.</p>
        </div>
       <div class="row" align="center">
            <div class="col-lg-3 ">
                <a href="#">
                    ...
                    <img alt="" src="spf/img/team/01.jpg" width="250" height="250">
                    <div class="title" style="color:grey;">
                        ...
                        <a id="myBtn3">Click here to view profile
                        </a></p> -->
                        <p style="text-align: left" "color:black;">
                                    
                                    The Senior Team, Inc. founder has experience working 
                    with senior living residences and communities, seniors 
                    and families. He is a Senior Real Estate Specialist.
                    Built and operated a tech company, which he scaled and 
                    led for 14 years, and exited successfully.
                    Marketing Director for Brookdale, Emeritus Senior 
                    Living, and Right At Home, home care.
                    Started Placement Company and contracted with Assisted 
                    Living  Companies for referral fees
                    Licensed real estate agent, with the SRES designation. 
                    He is the author of the successful book How to Capture
                    the Senior Real Estate Market for SRES Professionals, 
                    to  understand the elder care industry as a source for 
                    business.
                    He works under the business model he developed as a real 
                    estate agent and senior advisor, which he has now automated
                    through the Your Senior Team Internet platform.
                    He partners with Keller Williams VIP Properties under its 
                    broker services for his practice and the SREP Club. 
                                </p>
                    </div>
                </a>
            </div>
            <div class="offset-1 col-lg-3">
                <a href="#">
                    ...
                    <img alt="" src="spf/img/team/02d.jpg" width="250" height="250">
                    <div class="title" style="color:grey;">
                        <br>
                        <h4>
                            Aju Philips
                        ...
                        <!--<p style="text-align:center;">
                        <a id="myBtn4">Click here to view profile
                        </a></p> -->
                        <p style="text-align: left" "color:black;">
                    An accomplished technology executive with a
record of achievement in corporate growth through his strategic 
the leadership of technical initiatives and operations.
Strategic Planning, Business/IT Alignment, Business Relationship 
Management
Enterprise Architecture, ERP systems (SAP, BI),  Application  
Development, System Integration Global Implementation and 
Global operations Team Building & Leadership, Process Design 
& Improvement
Budgeting & Forecasting, Vendor, Contract Management
IT Transformation, Change Management, Program/Project 
Management
            ...
            <div class="offset-1 col-lg-3 ">
                <a href="#">
                    ...
                    <img alt="" src="spf/img/team/03.jpg" width="250" height="250">
                    <div class="title" style="color:grey;">
                        <br>
                        <h4>
                            Bill Wang
                        ...
                        <!--<p style="text-align:center;">
                        <a id="myBtn5">Click here to view profile
                        </a></p> -->
                        
                <p style="text-align: left;">
Having earned a Ph.D. in financial paradigms 
Served as a senior actuary for fortune 500 Companies
as an expert in building financial models and forecasts. 
He has vast experience setting up startup operations.
He has successfully implemented strategic fundraising
Most recently he has taken a start-up to generate
more than $6 million in revenue a year.
He has managed digital loyalty and reward programs
Operated as the financial planner and finance manager
for start-up.
He has the leading position in communicating with
investors and making sure they are kept up to date 
with the Corporation's progress and developments. 
         ...
         <div id = "myModalContainer">
                ...
                <div class="modal fade" id="myModal3" style="max-height: 500px !important; margin-top: 70px;">
        ...
        <div class="modal-dialog modal-dialog-scrollable modal-lg">
          ...
          <div class="modal-content">
            ...
            <h4 class="modal-title">Steve Fecske</h4>
      ...
      <div class="modal fade" id="myModal4" style="max-height: 500px !important; margin-top: 70px;">
        ...
        <div class="modal-dialog modal-dialog-scrollable modal-lg">
          ...
          <div class="modal-content">
            ...
            <h4 class="modal-title">Aju Philips</h4>
...
Management
      ...
      <div class="modal fade" id="myModal5" style="max-height: 500px !important; margin-top: 70px;">
        ...
        <div class="modal-dialog modal-dialog-scrollable modal-lg">
          ...
          <div class="modal-content">
            ...
            <h4 class="modal-title">Bill Wang</h4>
            ...
            <div class="col-lg-4 col-md-6 col-sm-6">
                ...
                <div class="collapse show" id="divQuickContacts">
                    ...
                    <ul class="contacts mt-3">
                        ...
                        </li>      <!--     "mailto:yst@ymctechno.com"       support@yourseniorteam.com - DASHBOARD -->
                    </ul>                                                       
                </div>
            </div>
            <div class="col-lg-4 col-md-6 col-sm-6">
...
<!---------------Floating widget validation starts--------------- -->
...
<!---------------Floating widget validation ends--------------- -->
